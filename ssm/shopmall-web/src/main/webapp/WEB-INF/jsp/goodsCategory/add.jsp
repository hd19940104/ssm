			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="gcname" placeholder="请输入商品名称">
				  </div>
				  <div class="form-group">
					<label for="remark">商品说明</label>
					<input type="text" class="form-control" id="remark" placeholder="请输入商品说明">
				  </div>
				   <div class="form-group">
        ...
        $(function(){
            ...
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
					...
					$.ajax({
						type :"post",
						url:"${APP_PATH }/goodsCategory/insertGood",
						data:{
							"name":gcname,
							"remark":remark,
							"orderid":orderid
						...
						success:function(result){
							...
							if (!result.success) {
								...
								layer.msg("添加商品成功", {time:3000, icon:6, shift:5}, function(){});
